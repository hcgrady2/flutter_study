  ...
  Widget build(BuildContext context) {
    return new Material(
      ...
      //    color: this.btnColor,
        ...
        child: new InkWell(
          //点击|触摸的时候,高亮显示的颜色
          highlightColor: this.touchColor!=Colors.white?this.touchColor:Theme.of(context).highlightColor,
          //波纹扩散颜色
          splashColor: this.rippleColor!=Colors.white?this.rippleColor:Theme.of(context).splashColor,
